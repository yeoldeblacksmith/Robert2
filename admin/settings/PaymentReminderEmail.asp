...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Payment Reminder Email Settings</title>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#previewEmail").click(function() {
                    previewType = "<%= SETTING_EMAILTEMPLATE_PAYMENTPENDING %>"
                    previewEmail(previewType, $("#" + "<%= SETTING_EMAILTEMPLATE_PAYMENTPENDING %>").val(), $("#" + "<%= SETTING_EMAILTEMPLATE_PAYMENTPENDING %>").val());
                });
            });
...
<%
    ...
    navmenu.HeadingTitle = "Payment Reminder Email Settings"
                ...
                <tr>
                    <td class="adminCell" style="padding: 10px">
                        <div class="floatRight">
                            <a href="#" onclick="editRegistration(<%= Settings(SETTING_DEFAULT_EVENTID) %>);">Edit Preview Data</a> &mdash;
                        ...
                        <table class="tableBorder marginCenter fullWidth">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input name="<%= SETTING_EMAILSUBJECT_PAYMENTPENDING%>" id="<%= SETTING_EMAILSUBJECT_PAYMENTPENDING%>" value="<%= Settings(SETTING_EMAILSUBJECT_PAYMENTPENDING) %>" class="fullWidth" />
                                </td>
                            </tr>
                            <tr class="alternate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <% 
                                        ...
                                        bodyEditor.Id = SETTING_EMAILTEMPLATE_PAYMENTPENDING
                                        bodyEditor.Text = settings(SETTING_EMAILTEMPLATE_PAYMENTPENDING)
                                        bodyEditor.Draw()
                                    %>
                                </td>
                            </tr>

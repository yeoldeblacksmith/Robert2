...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Waiver Email Settings</title>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#previewEmail").click(function() {
                    previewType = "<%= SETTING_EMAILTEMPLATE_WAIVER %>"
                    previewEmail(previewType, $("#" + "<%= SETTING_EMAILSUBJECT_WAIVER %>").val(), $("#" + "<%= SETTING_EMAILTEMPLATE_WAIVER %>").val()); 
                });
            });
...
<%
    ...
    navmenu.HeadingTitle = "Waiver Email Settings"
                ...
                <tr>
                    <td class="adminCell" style="padding: 10px">
                        ...
                        <table class="tableBorder marginCenter fullWidth">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input name="<%= SETTING_EMAILSUBJECT_WAIVER%>" id="<%= SETTING_EMAILSUBJECT_WAIVER%>" value="<%= Settings(SETTING_EMAILSUBJECT_WAIVER) %>" class="fullWidth" />
                                </td>
                            </tr>
                            <tr class="alternate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <% 
                                        ...
                                        bodyEditor.Id = SETTING_EMAILTEMPLATE_WAIVER
                                        bodyEditor.Text = settings(SETTING_EMAILTEMPLATE_WAIVER)
                                        bodyEditor.Draw()
                                    %>
                                </td>
                            </tr>

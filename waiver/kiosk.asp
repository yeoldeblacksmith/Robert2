...
%>
            ...
            function setHiddenPlayTime() {
                var now = new Date();
                var hh = now.getHours() < 10 ? "0" + now.getHours().toString() : now.getHours().toString();
                var mm;
                ...
                if (now.getMinutes() < 15) {
                    ...
                    hh = now.getHours() < 10 ? "0" + (now.getHours() + 1) : (now.getHours() + 1);
                    mm = "00";
                }

                var timeString = hh + ":" + mm;

                $("#txtPlayTime").val(timeString);
            }

            function timerIncrement() {
                idleTime = idleTime + 1;
                if (idleTime > 1) { // 2 minutes
                    if ($("#divLegalese").css("display") === "none") { window.location.reload(); }
                }
            }

            function toggleCalendar() {
                $("#rowMonth").css("display", "table-row");
                $("#rowCalendar").css("display", "table-row");
            }
    ...
    <body>
        ...
        <form id="myForm" action="savekiosk.asp" method="post" data-ajax="false">
        ...
        <div id="divWaiver" style="text-align: center; display: block;">
                <div id="divLegalese" style="text-align: center; display: none;">
                    <div style="width: 650px; margin: 15px auto; border: 1px solid grey; text-align:left;">
                       ...
                       <center><img src="<%= LOGO_URL %>" border="0" alt="Go to <%= SiteInfo.Name %> Home Page."  ></center>  
                            <%= printLegaleseText %>
                            </blockquote>
                    </div>

                    <blockquote style="text-align:left">By hitting accept, you are consenting to the use of your electronic signature in lieu of an original signature on paper. You have the right 
                        to request that you sign a paper copy instead which is available at our location. By hitting accept, you are waiving that right. After 
                        consent, you may, upon written request to us, obtain a paper copy of an electronic record. No fee will be charged for such copy and no 
                        special hardware or software is required to view it. Your agreement to use an electronic signature with us for any documents will continue 
                        until such time as you notify us in writing that you no longer wish to use an electronic signature. There is no penalty for withdrawing your 
                        consent. You should always make sure that we have a current email address in order to contact you regarding any changes, if necessary.</blockquote>
                    ...
                    <table style="margin: auto" >
                        <tr>
                            ...
                            <td>
                                <button type="button"  onClick="window.location.href = 'kiosknothanks.asp'">Decline</button>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="divPlayDate" class="waiverSection" style="display: none">
                    ...
                    <table class="blockCenter">
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtPlayDate" name="txtPlayDate" readonly="readonly" onClick="toggleCalendar()" />
                ...
                <div id="divPlayTime" class="waiverSection" style="display: none">
                    <input type="hidden" name="txtPlayTime" id="txtPlayTime" value="" />
                ...
                <div id="divSigContainer" class="waiverSection" style="display: none">
                    <h2>Signature</h2>
                   <h2 style="color:#CC0000; text-align:center">*Must be signed by an Adult, Parent or Legal Guardian.<br>MINORS DO NOT SIGN.</h2>
                  Sign by using your mouse, hold down the mouse button and move mouse to write.

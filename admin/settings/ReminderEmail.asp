...
<%
    ...
    if Request.ServerVariables("REQUEST_METHOD") = "POST" then
        for each key in Request.Form
            'settingsDict(key) = Request.Form(key)
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Reminder Email Settings</title>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#previewEmail").click(function() {
                    previewType = "<%= SETTING_EMAILTEMPLATE_REMINDER %>"
                    previewEmail(previewType, $("#" + "<%= SETTING_EMAILSUBJECT_REMINDER %>").val(), $("#" + "<%= SETTING_EMAILTEMPLATE_REMINDER %>").val()); 
                });
            });
...
<%
    ...
    navmenu.HeadingTitle = "Reminder Email Settings"
                ...
                <tr>
                    <td class="adminCell" style="padding: 10px">
                        ...
                        <table class="tableBorder marginCenter fullWidth">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input name="<%= SETTING_EMAILSUBJECT_REMINDER%>" id="<%= SETTING_EMAILSUBJECT_REMINDER%>" value="<%= Settings(SETTING_EMAILSUBJECT_REMINDER) %>" class="fullWidth" />
                                </td>
                            </tr>
                            <tr class="alternate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <% 
                                        ...
                                        bodyEditor.Id = SETTING_EMAILTEMPLATE_REMINDER
                                        bodyEditor.Text = settings(SETTING_EMAILTEMPLATE_REMINDER)
                                        bodyEditor.Draw()
                                    %>
                                </td>
                            </tr>

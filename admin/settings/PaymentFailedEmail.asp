...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Payment Failed Email Settings</title>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#previewEmail").click(function() {
                    previewType = "<%= SETTING_EMAILTEMPLATE_PAYMENTFAILED %>"
                    previewEmail(previewType, $("#" + "<%= SETTING_EMAILTEMPLATE_PAYMENTFAILED %>").val(), $("#" + "<%= SETTING_EMAILTEMPLATE_PAYMENTFAILED %>").val());
                });
            });
...
<%
    ...
    navmenu.HeadingTitle = "Payment Failed Email Settings"
                ...
                <tr>
                    <td class="adminCell" style="padding: 10px">
                        ...
                        <table class="tableBorder marginCenter fullWidth">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input name="<%= SETTING_EMAILSUBJECT_PAYMENTFAILED%>" id="<%= SETTING_EMAILSUBJECT_PAYMENTFAILED%>" value="<%= Settings(SETTING_EMAILSUBJECT_PAYMENTFAILED) %>" class="fullWidth" />
                                </td>
                            </tr>
                            <tr class="alternate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <% 
                                        ...
                                        bodyEditor.Id = SETTING_EMAILTEMPLATE_PAYMENTFAILED
                                        bodyEditor.Text = settings(SETTING_EMAILTEMPLATE_PAYMENTFAILED)
                                        bodyEditor.Draw()
                                    %>
                                </td>
                            </tr>

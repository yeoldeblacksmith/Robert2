...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Confirmation Email Settings</title>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#previewEmail").click(function() {
                    previewType = "<%= SETTING_EMAILTEMPLATE_CONFIRMATION %>"
                    previewEmail(previewType, $("#" + "<%= SETTING_EMAILSUBJECT_CONFRIMATION %>").val(), $("#" + "<%= SETTING_EMAILTEMPLATE_CONFIRMATION %>").val()); 
                });
            });
...
<%
    ...
    navmenu.HeadingTitle = "Confirmation Email Settings"
                ...
                <tr>
                    <td class="adminCell" style="padding: 10px">
                        ...
                        <table class="tableBorder marginCenter fullWidth">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input name="<%= SETTING_EMAILSUBJECT_CONFIRMATION%>" id="<%= SETTING_EMAILSUBJECT_CONFIRMATION%>" value="<%= Settings(SETTING_EMAILSUBJECT_CONFIRMATION) %>" class="fullWidth" />
                                </td>
                            </tr>
                            <tr class="alternate">
                            ...
                            <tr>
                                ...
                                <td>
                                    <% 
                                        ...
                                        bodyEditor.Id = SETTING_EMAILTEMPLATE_CONFIRMATION
                                        bodyEditor.Text = settings(SETTING_EMAILTEMPLATE_CONFIRMATION)
                                        bodyEditor.Draw()
                                    %>
                                </td>
                            </tr>
